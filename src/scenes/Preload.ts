...
export default class Preload extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		// abstract_bg_blueswirl
		const abstract_bg_blueswirl = this.add.image(650, 266, "Abstract_bg_blueswirl");
		abstract_bg_blueswirl.scaleX = 1.4382044772068359;
		abstract_bg_blueswirl.scaleY = 1.4382044772068359;
